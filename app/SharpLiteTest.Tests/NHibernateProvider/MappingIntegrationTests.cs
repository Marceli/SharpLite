using System.IO;
using SharpLiteTest.NHibernateProvider;
using NHibernate;
using NHibernate.Cfg;
using NHibernate.Tool.hbm2ddl;
using NUnit.Framework;

namespace SharpLiteTest.Tests.NHibernateProvider
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public void CanGenerateDatabaseSchema() {
            using (ISession session = _sessionFactory.OpenSession()) {
                using (TextWriter stringWriter = new StreamWriter("../../../../app/SharpLiteTest.DB/Schema/UnitTestGeneratedSchema.sql")) {
